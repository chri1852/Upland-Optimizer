...
namespace Upland.Types
{
    public static class Consts
    {
        ...
        public static readonly string AuthToken = @"eyJhbGciOiJIUzI1NiIsInR5cCI6ImFjY2VzcyJ9..6mTSqACfKqpxj3nOW_ierAd4m-TY8JjUjAsRr_cJDxY";

        // Config Values
        public static readonly string CONFIG_AUTHTOKEN = "AuthToken";
        public static readonly string CONFIG_MAXGLOBALSEQUENCE = "MaxGlobalSequence";
        public static readonly string CONFIG_DBCONNECTIONSTRING = "DBConnectionString";
